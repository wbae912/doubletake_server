...
const { MAPQUEST_API_KEY, WEATHER_API_KEY, WEATHERMAP_API_KEY } = require('../config');
...
weatherRouter
  ...
  .get(requireAuth, async (req,res,next) => {
    ...
    // const weather_api_url = `https://api.darksky.net/forecast/${WEATHER_API_KEY}/${latitude},${longitude}`;
